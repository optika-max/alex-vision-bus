...
export const DiagnosticsInfo = () => {
  ...
  const features = [
    { icon: Clock, text: "~30 хвилин" },
    { icon: Shield, text: "Безболісно" },
    { icon: Sparkles, text: "Сучасні технології" },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            <div className="relative">
              ...
              <img 
                src={busConsultation} 
                alt="Консультація в офтальмобусі" 
          ...
          <div className="space-y-8 order-1 lg:order-2">
            ...
            <div className="space-y-4">
              {included.map((item, index) => (
                <div 
                  key={index}
                  className="flex items-start gap-3 p-4 bg-card rounded-lg border border-border/50 hover:border-accent/50 transition-colors"
                >
