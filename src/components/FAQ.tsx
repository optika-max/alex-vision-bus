...
export const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Якщо діагностика виявить проблеми, наш лікар надасть детальні рекомендації та запропонує план лікування. За потреби можна записатися на прийом у наш центр у Києві або продовжити лікування за місцем проживання.",
    },
  ];
