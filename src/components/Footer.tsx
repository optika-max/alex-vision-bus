...
export const Footer = () => {
  return <footer className="bg-primary text-primary-foreground py-12 lg:py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="lg:col-span-2">
            <img src={alexLogo} alt="Alex Офтальмологічний Центр" className="h-12 w-auto mb-6 brightness-0 invert" />
            <p className="text-primary-foreground/80 mb-6 leading-relaxed max-w-md">
              Відновлюємо зір. Повертаємо радість життя. Офтальмологічний центр Alex — ваш партнер у здоров'ї очей.
            </p>
            <a href="https://alexcentr.com.ua" target="_blank" rel="noopener noreferrer" className="text-accent hover:text-accent/80 transition-colors font-medium">
              alexcentr.com.ua
            </a>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="tel:0800332143" className="flex items-start gap-3 text-primary-foreground/80 hover:text-primary-foreground transition-colors group">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3 text-primary-foreground/80">
                ...
                <div className="text-sm">Режим роботи: щоп'ятниці
за попереднім записом</div>
              </div>
            </div>
          </div>
        </div>
